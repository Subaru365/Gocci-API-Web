...
class Model_V2_DB_Restaurant extends Model
{
     ...
     * @return $near_data
     */
    public static function getNear($lon, $lat)
    {
     ...
     * @return $rest_data
     */
    public static function getData($user_id, $rest_id)
    {
        $query = DB::select(
        ...
        $rest_data[0]['want_flag'] = Model_V3_Db_Want::get_flag($user_id, $rest_id);
        $rest_data[0]['cheer_num'] = Model_V3_DB_Post::get_rest_cheer_num($rest_id);
     ...
     * @return $rest_id
     */
    public static function postAdd($rest_name, $lat, $lon)
    {
